  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-textSec text-sm">Estimación y calculadora de infraestructura AWS.</p>
      </div>
      ...
      {/* Gráfico de distribución de costos (requerido) */}
      ...
      {/* Agregar Servicio */}
      <form onSubmit={handleAddCost} className="bg-cards border border-borders p-5 rounded-2xl shadow-xs flex flex-wrap gap-4 items-end">
        <div className="flex-1 min-w-[200px]">
          ...
          <input
            ...
            className="w-full border border-borders p-2.5 rounded-xl text-sm bg-bgMain"
        ...
        <button type="submit" className="bg-primary text-white px-5 py-2.5 rounded-xl text-sm font-medium flex items-center gap-2 hover:bg-blue-700 transition-colors">
          <Plus size={18} /> Añadir Estimación
        </button>
      </form>

      {/* Lista de Costos usando CostCard reutilizable */}

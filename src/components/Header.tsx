...
export const Header: React.FC<HeaderProps> = ({ onMenuClick }) => {
  ...
  return (
    <header className="bg-cards border-b border-borders h-16 px-4 sm:px-8 flex items-center justify-between shadow-xs sticky top-0 z-20 transition-colors duration-250">

...
export const INITIAL_SERVICES: AWSService[] = [
  { id: '1', name: 'EC2', category: 'Compute', description: 'Capacidad de cómputo escalable en la nube.', mainFunction: 'Servidores de aplicaciones y cómputo backend', status: 'Active', monthlyCost: 180 },
  { id: '2', name: 'S3', category: 'Storage', description: 'Almacenamiento de objetos diseñado para almacenar y recuperar cualquier cantidad de datos.', mainFunction: 'Respaldo, almacenamiento de objetos y static hosting', status: 'Active', monthlyCost: 45 },
  { id: '3', name: 'RDS', category: 'Database', description: 'Base de datos relacional administrada para MySQL, PostgreSQL, Oracle, SQL Server.', mainFunction: 'Persistencia de datos transaccionales', status: 'Active', monthlyCost: 220 },
  ...
  { id: '5', name: 'VPC', category: 'Networking', description: 'Red virtual aislada para aprovisionar recursos en la nube.', mainFunction: 'Aislamiento de red, subredes y tablas de ruteo', status: 'Active', monthlyCost: 0 },
  { id: '6', name: 'Route 53', category: 'Networking', description: 'Servicio de DNS web escalable y de alta disponibilidad.', mainFunction: 'Administración de DNS y chequeos de salud', status: 'Active', monthlyCost: 15 },
  { id: '7', name: 'CloudFront', category: 'Networking', description: 'Red de distribución de contenido (CDN) rápida para entregar datos de forma segura.', mainFunction: 'Caché de contenido estático/dinámico y aceleración', status: 'Active', monthlyCost: 65 },
];

export const MOCK_REGIONS: RegionInfo[] = [
  { id: 'us-east-1', name: 'US East (N. Virginia)', location: 'EE.UU. Este', deployedServicesCount: 7, status: 'Operational' },
  { id: 'us-west-2', name: 'US West (Oregon)', location: 'EE.UU. Oeste', deployedServicesCount: 4, status: 'Operational' },
  { id: 'sa-east-1', name: 'South America (São Paulo)', location: 'Sudamérica', deployedServicesCount: 2, status: 'Operational' },
  { id: 'eu-west-1', name: 'EU (Ireland)', location: 'Europa', deployedServicesCount: 3, status: 'Maintenance' },
];
